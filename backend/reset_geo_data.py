...
china_data = [
    ...
    {
        "name": "台湾省",
        "cities": ["台北市", "高雄市", "台南市", "台中市", "新北市", "桃园市", "新竹市", "基隆市", "嘉义市", "新竹县", "宜兰县", "苗栗县", "彰化县", "南投县", "云林县", "嘉义县", "屏东县", "澎湖县", "花莲县", "台东县", "金门县", "连江县"]
    }
]

async def reset_geo_data():
    async with async_session() as session:
        ...
        for province_data in china_data:
            ...
            for city_name in province_data["cities"]:
                city = City(province_id=province.id, name=city_name)
                session.add(city)
        
        await session.commit()
        print(f"省份和城市数据初始化完成！共插入 {len(china_data)} 个省份")

if __name__ == "__main__":
    asyncio.run(reset_geo_data())
