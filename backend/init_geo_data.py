...
china_data = [
    ...
    {
        "name": "台湾省",
        "cities": ["台北市", "高雄市", "台南市", "台中市", "金门县", "连江县", "新北市", "桃园市", "新竹市", "基隆市", "新竹县", "宜兰县", "苗栗县", "彰化县", "南投县", "云林县", "嘉义市", "嘉义县", "屏东县", "澎湖县", "花莲县", "台东县"]
    }
]
...
async def init_geo_data():
    async with async_session() as session:
        ...
        existing_provinces = result.scalars().all()
